    ...
    <nav class="navbar navbar-default navbar-fixed-top" style="background:#d74b35;">
      <div class="container-fluid">
        <div class="navbar-header">
           ...
           <a class="navbar-brand" href="#" style="color:#fff; font-size:30px;">DODOL<b>BUKU</b></a>
        </div>
...
<li><?php include("kat.php");?></li>
   ...
   <img src="img/HAL.jpg">
      ...
      <div class="col-md-6" style="margin-left:70px; margin-top: 80px;">
        <h2><b>Selamat datang di toko buku murah.<h1 style="color:#f97b61;">TO<b>  GUSING</b></h1></h2>
        <p>disini anda bisa membeli dan memesan buku dengan mudah, anda tinggal klik, maka buku sampai di tempat anda. tidak perlu lagi jauh jauh ke toko kamera.</p>
      </div>
    </div>
    </div>
...
<b>Buku Kami</b>
    ...
    <div class="footer" style="width:100%;height:270px;color:#fff;background:#d74b35;">
      ...
      <div style="margin:50px;height:120px;">
        <center>
        <ul>
          <li style="color:#f97b61"><h3><b>Tentang TOGUSING</b></h3></li>
        </ul></center>
          <hr>
        <ul>
      ...
      <div style="margin:50px;height:120px;">
        ...
        <ul>
          ...
          <ul>
          <li>Jl.Ahmad Yani No 42</li>
          <li>Senduro, lumajang</li>
